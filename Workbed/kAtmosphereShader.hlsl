...
atmosphere_parameters.solar_irradiance = float3(1.474000, 1.850400, 1.911980);
atmosphere_parameters.sun_angular_radius = 0.004675;
atmosphere_parameters.bottom_radius = 6360.000000;
atmosphere_parameters.top_radius = 6420.000000;
atmosphere_parameters.rayleigh_scale_height = 8.000000;
atmosphere_parameters.rayleigh_scattering = float3(0.005802, 0.013558, 0.033100);
atmosphere_parameters.mie_scale_height = 1.200000;
atmosphere_parameters.mie_scattering = float3(0.003996, 0.003996, 0.003996);
atmosphere_parameters.mie_extinction = float3(0.004440, 0.004440, 0.004440);
atmosphere_parameters.mie_phase_function_g = 0.800000;
atmosphere_parameters.ground_albedo = float3(0.100000, 0.100000, 0.100000);
atmosphere_parameters.mu_s_min = 1.780236;
