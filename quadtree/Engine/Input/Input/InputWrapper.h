...
#include "Common Utilities\CommonUtilities\Misc\Global.h"
#include <dinput.h>
...
namespace CommonUtilities
{
	...
	namespace Input
	{
		...
		public:
			...
			Vector2f GetMouseDeltaPositionInPixels() const;
			void SetMouseSpeed(const float aMouseSpeed);

			void CaptureWindowsCursor();
			void ReleaseCursor();
			void SetCursorPosition(Vector2f aPosition);
		...
		private:
			...
			Position myCoord;
			Vector2f myDimensions;

			Vector2f myMousePos;
			Vector2f myOldMousePos;
			Vector2f myScreen;
