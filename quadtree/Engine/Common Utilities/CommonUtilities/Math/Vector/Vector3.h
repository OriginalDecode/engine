...
namespace CommonUtilities
{
	namespace Math
	{
		...
		template<typename T>
		const Vector3<T> operator+(const Vector3<T>& aFirstVector, const Vector3<T>& aSecondVector)
		{
		...
		\****************************/
		template<typename T>
		Vector3<T> operator+=(Vector3<T>& aFirstVector, Vector3<T>& aSecondVector)
		{
		...
		\****************************/
		template<typename T>
		const Vector3<T> operator+(const Vector3<T>& aFirstVector, const T aScale)
		{
		...
		template<typename T>
		Vector3<T> operator+=(Vector3<T>& aFirstVector, const T aScale)
		{
			aFirstVector.x += aScale;
			aFirstVector.y += aScale;
			aFirstVector.z += aScale;
