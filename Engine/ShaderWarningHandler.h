...
private:
	...
	uint32 CountWord(char* aWord, int32 aWordLength, const std::string& aMessage);
	std::tuple<bool, std::string> CreateMessage(char* aWordToFind, int8 aWordLength, const std::string& aMessage);
