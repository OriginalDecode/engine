...
namespace CommonUtilities
{
	namespace Math
	{
		...
		\****************************/
		template<typename T>
		const Vector4<T> operator+(const Vector4<T>& aFirstVector, const Vector4<T>& aSecondVector)
		{
		...
		\****************************/
		template<typename T>
		const Vector4<T> operator+(const Vector4<T>& aFirstVector, const T aScale)
		{
			return Vector4<T>
		...
		\****************************/
		template<typename T>
		Vector4<T> operator+=(Vector4<T>& aFirstVector, const T aScale)
		{
			aFirstVector.x += aScale;
			aFirstVector.y += aScale;
			aFirstVector.z += aScale;
