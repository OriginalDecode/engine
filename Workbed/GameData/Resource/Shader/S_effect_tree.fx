...
PS_INPUT_1UVSET VS_1UVSET(VS_INPUT_1UVSET_INSTANCED input)
{
	...
	PBLVertexShaderData vertexData = CalcVertexShaderData_Instanced_Tree(input.Position, input.Normal
	, input.Tex, input.BiNormal, input.Tangent, locWorld, input.scale, input.height);
